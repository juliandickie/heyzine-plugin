...
// Error messages travel into logs, results CSVs and chat, and a source URL can carry a
// signed token in its query string. Strip the query and the fragment before printing one.
